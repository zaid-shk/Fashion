...
const Footer = () => {
  return (
    <footer className="bg-[#fdfaf4] px-10 py-10 text-[#222]">
      {/* Top Section */}
      <div className="flex justify-between">
        {/* Newsletter */}
        <div>
          <h2 className="text-2xl font-bold">GET THE LATEST TRENDS</h2>
          ...
          <div className="mt-8 flex items-center">
            <input
              ...
              className="h-12 w-[310px] rounded-full border border-gray-200 bg-transparent px-5 outline-none"
            />

            <button className="-ml-[-5px] h-12 rounded-full bg-black px-6 text-lg text-white">
              Subscribe
            </button>
          </div>
        </div>
