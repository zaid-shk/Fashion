...
import { selectMenProducts } from "@/lib/redux/slices/productSlice";
...
const MenProducts = ({ sortBy, activeFilters, onCount }: ProductsProps) => {
    const [page, setPage] = useState(1);
    const dispatch = useAppDispatch();
    const ProductData = useAppSelector(selectMenProducts);
